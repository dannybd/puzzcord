...
class PuzzcordBot(commands.Bot):
    def __init__(self, *args, **kwargs):
        ...
        self.hunt_begins = datetime.datetime(2024, 1, 12, hour=12, minute=0, tzinfo=self.tz)
        self.hunt_ends = datetime.datetime(2024, 1, 15, hour=12, minute=0, tzinfo=self.tz)
